...
print(f"RandomForest ROC-AUC: {roc_auc_score(y_test, y_proba):.4f}")

# === Save Model & Scaler ===
joblib.dump(rf_model, 'shoplifting_classifier_rf.pkl')
joblib.dump(scaler, 'shoplifting_scaler_rf.pkl')
